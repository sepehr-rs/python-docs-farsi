...
- [STATUS.md](STATUS.md) — جدول وضعیت ترجمه‌ی فایل‌ها که به‌صورت خودکار به‌روزرسانی می‌شود.

### شاخه‌های نسخه

ترجمه‌ها به‌ازای هر نسخه‌ی پایتون در یک شاخه‌ی جدا نگهداری می‌شوند. شاخه‌ی فعلی و پیش‌فرض، نسخه‌ی `3.14` است و پول‌ریکوئست‌ها باید روی همین شاخه باز شوند (برای مثال روی فایل‌های `tutorial/`، `library/`، `c-api/` و غیره). هنگام انتشار نسخه‌ی جدید پایتون، هماهنگ‌کننده‌ها شاخه‌ی جدیدی ایجاد و ترجمه‌ها را به آن منتقل می‌کنند.
